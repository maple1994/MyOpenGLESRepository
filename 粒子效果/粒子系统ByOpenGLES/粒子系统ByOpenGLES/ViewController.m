...
//管理并且绘制所有的粒子对象
@property (strong, nonatomic) MPPointParticleEffect *particleEffect;
...
- (void)viewDidLoad {
    ...
    self.particleEffect = [[MPPointParticleEffect alloc] init];
    ...
    void(^blockA)() = ^{
        ...
        //重力
        self.particleEffect.gravity = MPDefaultGravity;
